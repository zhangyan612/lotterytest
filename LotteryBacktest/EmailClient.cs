    ...
    public class EmailClient
    {
        public static void Sending(string message)
        {
            try
            {
                ...
                string toMailAddress = "lotteryalert@163.com";
                string fromMailAddress = "232233632@163.com";
                string subjectInfo = "Error occured in Lottery Machine";
                string bodyInfo = message;
                string mailUsername = "232233632";
                string mailPassword = "zymeng90612"; 
                string mailPort = "25";
                ...
                string attachPath = string.Format("./Logs/{0}.txt", time);
